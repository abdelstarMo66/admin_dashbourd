...
if(isset($_GET['delete_Admin']))
{
    ...
    header("location:  /project/screens/profile/list_admin.php ");
}
...
<tbody>
    ...
    <tr>
        ...
        <td><a href="/project/screens/profile/list_admin.php?delete_Admin=<?= "$get_data[id]" ?>" class="btn btn-danger">Delete</a></td>
    </tr>
        <?php } ?>
</tbody>
</table>
