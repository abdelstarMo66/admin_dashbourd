...
if (isset($_POST['insert'])) 
{
    ...
    $description = $_POST['description'];
      ...
      if (empty($_FILES['image']['name'])) {
          $addData = "INSERT INTO `articales` VALUES (null,'$title','$description','$auther','','$imageProfile','','')";
      }
      else {
          ...
          $addData = "INSERT INTO `articales` VALUES (null,'$title','$description','$auther','/project/screens/employee/upload/$img_name','$imageProfile','','')";
        };
