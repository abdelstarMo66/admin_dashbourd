...
<div class="card" style="width: 18rem;">
    ...
    <div class="card-body">
        ...
        <a href="/project/screens/articales/update.php?edit_post=<?= $data['id'] ?>" class="btn btn-primary">Edit</a>
        <a href="/project/screens/articales/list.php?delete_post=<?= $data['id'] ?>" class="btn btn-danger">Delete</a>
    </div>
</div>
<br> <br> <br>
<?php } ?>
