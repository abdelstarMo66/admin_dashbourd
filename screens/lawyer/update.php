...
if(isset($_POST['update']))
{
    ...
    $updateEmpData = "UPDATE `lawyers` SET `name`='$name',`age`=$age,`address`='$address',`salary`=$salary,`years_ex`=$years_ex,`phone`='$phone',`email`='$email',`password`='$password',`image`='$row[9]' WHERE `id` = $id";
    }
  else {
    ...
    move_uploaded_file($img_temp, $location);
    $updateEmpData = "UPDATE `lawyers` SET `name`='$name',`age`=$age,`address`='$address',`salary`=$salary,`years_ex`=$years_ex,`phone`='$phone',`email`='$email',`password`='$password',`image`='/project/screens/lawyer/uploads/$imgUpdate_name' WHERE `id` = $id";
  };
...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" name="years_ex" value="<?= $row[5] ?>">
    </div>
    <div class="form-group">
